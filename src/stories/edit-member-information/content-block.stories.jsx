    ...
    content: (
        <div>
            <div className="form-group mt-2 mb-2">
                ...
                <input type="text" className="form-control" id="first-name" value="Anatoliy"/>
            </div>
            <div className="form-group mt-2 mb-2">
                <label htmlFor="last-name" className="fw-bold">Last Name</label>
                <input type="text" className="form-control" id="last-name" value="Kolodkin"/>
            </div>
            <div className="form-group mt-2 mb-2">
                <label htmlFor="title" className="fw-bold">Title</label>
                <input type="text" className="form-control" id="title" value="CEO"/>
            </div>
...
InviteLink.args = {
    ...
    content: (
        <div>
            ...
            <textarea id="link-for-invite"
                      className="form-control copy-link-textarea mx-auto"
                      type="text"
                      readOnly>https://github.com/codemakeracademy/weekly-team-report-html/pull/75/commits/7826b47b6fabe366fbb895b60c49c7e4a670b296</textarea>
