...
export function RadioSmileContainer({mainLabel, containerInputName, containerLabels}){
    ...
    return(
        <div className="mt-5">
            <h2 className="content-block-title fw-bold p-4">How was your morale this week?</h2>
            <div className="row">
                {radioButtons}
            </div>
        </div>
